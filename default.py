...
if mode==None or url==None or len(url)<1:
        ...
        mk4.deletecachefiles(url)

elif mode==5:
        mk4.YouTube(url)

elif mode==6:        
	mk4.FRESHSTART(params)
	
elif mode==7:
       mk4.DeletePackages(url)
       ...
       mk4.DeleteThumbnails(url)

elif mode==12:
        mk4.UNIVERSAL_BACKUP()
...
#        UKBUILDS()
        ...
        mk4.WIZARD(name,url,version)

elif mode==28:
        mk4.killxbmc() # Temp hidden test button.
    ...
    mk4.GetAceStream()
        ...
        mk4.APKDOWNWIZ('Firefox','http://mkiv.netne.net/Admin/APKs/Firefox.zip','Firefox')
        ...
        mk4.INSTALL_FANRIFFIC(name,url, description)
    ...
    mk4.BackupSkinSettings()
    
elif mode==60:
    mk4.RestoreSkinSettings()

elif mode==61:
    mk4.DeleteSkinBackup()
