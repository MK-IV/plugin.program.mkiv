...
def BuildAWizard():
    ...
    f.write(str(b))
    f.close()
    dp.update(60,'Copying core files...[COLOR lime]Complete[/COLOR]','Personalizing '+name+'...[COLOR lime]Complete[/COLOR]','Creating installable zip file...')
    time.sleep(1)
    ZipIt(workfolder, workfolder,'plugin.program.'+id)
    time.sleep(.5)
    shutil.copy(outputfile,fullworkpath)
    time.sleep(.5)
    dp.update(90,'Copying core files...[COLOR lime]Complete[/COLOR]','Personalizing '+name+'...[COLOR lime]Complete[/COLOR]','Creating installable zip file...[COLOR lime]Complete[/COLOR]')
    time.sleep(1)
    dp.close()
    dp.create(Title,'Cleaning up...')
    time.sleep(1)
    ...
    time.sleep(1)
    dp.close()
    dialog.ok(Title, 'Your wizard is finished and saved to:','[COLOR deepskyblue]'+fullworkpath+'[/COLOR]','You can replace the icon.png file to your own, just make sure it\'s called \'[COLOR deepskyblue]icon.png[/COLOR]\'')
    sys.exit()
